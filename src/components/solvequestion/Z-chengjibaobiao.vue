  ...
  <div class="ba0biaoon">
    ...
    <div class="tcon">
      <p class="ac">2019-2020三年级上册科学考试</p>
       ...
       <ul class="oul">
      <li>
        <span class="zh zco">考生</span><span class="infor">{{allmsg.user_name}}</span>
      </li>
       <li>
       ...
       <li>
         ...
         <p class="gainnum">
           <span class="zh">试题得分</span> <span class="zhunum">主观题:{{allmsg.notObjectiveScore}}分</span>
           <span class="kenum">客观题:{{allmsg.objectiveScore}}分</span>
         </p>
