<template>
  <div class="chengjicon">
    ...
    <div class="cheng" v-for="(item,i) in alltest" :key="i">
      ...
      <p>结束时间:{{item.get_test_paper_info.test_end}} | 总分:{{item.get_test_paper_info.all_score}} |
        得分:{{item.get_test_paper_info.pass_score}} |考试时长:{{item.get_test_paper_info.test_use_time}}</p>
      <div class="bbox">
    ...
    <!-- 分页按钮 -->
    <el-pagination background layout="prev, pager, next" :total="pagecount" class="fenye" @current-change="huanye">
    </el-pagination>
